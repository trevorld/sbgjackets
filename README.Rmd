...
`r sbgjackets:::readme_markdown_table(sbgjackets:::df_pcw())`
...
| --- | --- | --- |
| Quantity | Over 1,600 pre-made jackets | `r nrow(sbgjackets:::df_pcbj()) + nrow(sbgjackets:::df_sbgj())` pre-made jackets |
