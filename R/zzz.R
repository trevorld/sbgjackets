...
df_sbgj <- function() {
	...
	df <- tibble::tribble(
		...
		"Game Pieces", NA_character_, "`sbgj_game_pieces()`", "CC-BY-ND-4.0",
		...
		"Meeples", NA_character_, "`sbgj_meeples()`", "CC-BY-NC-SA-2.0",
...
df_pcbj <- function() {
	...
	df <- tibble::tribble(
		...
		"Everdeck", "https://thewrongtools.wordpress.com/2019/10/10/the-everdeck/", "`pcbj_everdeck()`", "Personal Use Only",
		...
		"Game Pieces", NA_character_, "`pcbj_game_pieces()`", "CC-BY-ND-4.0",
		...
		"Meeples", NA_character_, "`pcbj_meeples()`", "CC-BY-NC-SA-2.0",
